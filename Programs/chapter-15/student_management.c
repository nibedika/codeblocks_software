...
struct sinfo {
	...
	float gpa;
	int sub_code[20];
} st[100]; /* st হলো স্ট্রাকচারটির ইনস্ট্যান্স। সর্বোচ্চ্য 100 জন
শিক্ষার্থীর তথ্য নেওয়ার জন্য এখানে সাইজ 100 নেওয়া হয়েছে। আমরা চাইলে
আমাদের ইচ্ছে মতো নিতে পারবো। এই সাইজের সাথে মেম্বার ভ্যারিয়েবলগুলোর
সাইজের সম্পর্ক নেই।  */
...
void update_student()
{
	...
	long int x; /* ইন্টিজার এর সাইজ আমরা জোর করে বাড়াবার জন্য int
	এর আগে long কীওয়ার্ড ব্যবহার করতে পারি এভাবে। আবার long long
	ও ব্যবহার করা যাবে। int এর সাইজ 2বাইট হলেও long int এর সাইজ 4
	এবং long long int এর সাইজ 8 হয়ে যায়। */
	scanf("%d", &x);
...
void delete_student()
{
	...
	for (int j = 1; j <= i; j++) {
		if (x == st[j].roll) {
			/* এখানেও আমরা চাইলে যেই 100 জন শিক্ষার্থী নিবো সেই পর্যন্তই ডিলিট এর রেঞ্জ রাখতে পারি */
			for (int k = j; k < 49; k++)
				st[k] = st[k + 1];
			i--;
		}
...
/* পূর্বে শিক্ষার্থীর সংখ্যা 100 নেওয়ায় এখানেও সেই লিমিট পর্যন্তই লুপ চালানো হয়েছে  */
	while(i < 100) {
        ...
        if (scanf("%d", &choice) != 1) {
            ...
            while (getchar() != '\n'); // ইনপুট ইন্টিজার না হলে ইনপুট ক্লিয়ার করে দেওয়া, getchar() ফাংশন শুধু একটু ক্যারেক্টার ইনপুট নেওয়া কাজে আসে।
            continue; // while এর কন্ডিশন ম্যাচ করলে, পরবর্তী কোড রান হবে না
        }

        // সঠিক অপসন সিলেক্ট না করলে আবার লুপের শুরুতে ফিরে যাওয়ার জন্য
